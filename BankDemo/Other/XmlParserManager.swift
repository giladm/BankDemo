...
//
//  copied from Arled Kola. modified by gm
//
...
class XmlParserManager: NSObject, XMLParserDelegate {
    ...
    func parser(_ parser: XMLParser, foundCharacters string: String) {
        if element.isEqual(to: "title") {
            ...
            fdate.append(string)
        } else if (lastBuildDate as NSString).isEqual(to:"") && element.isEqual(to: "lastBuildDate") { //gm
            lastBuildDate = string as NSString
        }
    }
}
